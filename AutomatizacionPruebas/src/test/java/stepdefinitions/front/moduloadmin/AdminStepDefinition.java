...
public class AdminStepDefinition extends PageObject {
    ...
    public void que_el_admin_ya_se_encuentra_en_panael_admin() {
        // Write code here that turns the phrase above into concrete actions
        System.out.println("***Desarrollo***");
    }
    @When("Selecciona la opcion listar producto")
    public void selecciona_la_opcion_listar_producto() {
        // Write code here that turns the phrase above into concrete actions
        System.out.println("***Desarrollo***");
    }
    ...
    public void selecciona_la_opcion_agregar_producto() {
        // Write code here that turns the phrase above into concrete actions
        System.out.println("***Desarrollo***");
    }
    @Then("visualiza agregar producto")
    public void visualiza_agregar_producto() {
        // Write code here that turns the phrase above into concrete actions
        System.out.println("***Desarrollo***");
    }
    ...
    public void selecciona_la_opcion_administrar_caracteristica() {
        // Write code here that turns the phrase above into concrete actions
        System.out.println("***Desarrollo***");
    }
    @Then("visualiza las caracteristicas")
    public void visualiza_las_caracteristicas() {
        // Write code here that turns the phrase above into concrete actions
        System.out.println("***Desarrollo***");
    }
