...
var _excluded3 = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
...
var Tab = React3.forwardRef(function Tab2(inProps, ref) {
  ...
  const icon = iconProp && label && React3.isValidElement(iconProp) ? React3.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime4.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime4.jsxs)(React3.Fragment, {
      children: [icon, label]
...
true ? Tab.propTypes = {
   ...
   * The icon to display.
   */
  icon: import_prop_types3.default.oneOfType([import_prop_types3.default.element, import_prop_types3.default.string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: import_prop_types3.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * The label element.
   */
...
true ? Tabs.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types6.default.bool,
  /**
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types6.default.oneOfType([import_prop_types6.default.oneOf(["primary", "secondary"]), import_prop_types6.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types6.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types6.default.oneOf(["auto", false, true]),
  /**
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types6.default.object,
  /**
   * Props applied to the [`TabScrollButton`](/material-ui/api/tab-scroll-button/) element.
   * @default {}
   */
  TabScrollButtonProps: import_prop_types6.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types6.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types6.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types6.default.bool
} : void 0;
...
//# sourceMappingURL=chunk-66AGBPDV.js.map
