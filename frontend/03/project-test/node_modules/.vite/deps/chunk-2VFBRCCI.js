...
var _excluded4 = ["props", "getOpenDialogAriaText"];
var useMobilePicker = (_ref) => {
  var _innerSlotProps$toolb, _innerSlotProps$toolb2, _slots$layout;
  let {
    props,
    getOpenDialogAriaText
  } = _ref, pickerParams = _objectWithoutPropertiesLoose(_ref, _excluded4);
  const {
    slots,
    slotProps: innerSlotProps,
    className,
  ...
  const renderPicker = () => (0, import_jsx_runtime4.jsxs)(LocalizationProvider, {
    ...
    children: [(0, import_jsx_runtime3.jsx)(Field, _extends({}, fieldProps, {
      ...
      slotProps,
      inputRef: handleInputRef
    })), (0, import_jsx_runtime3.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
...
//# sourceMappingURL=chunk-2VFBRCCI.js.map
