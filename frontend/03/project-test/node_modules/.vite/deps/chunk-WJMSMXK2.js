...
var useFieldState = (params) => {
  ...
  const sectionsValueBoundaries = React15.useMemo(() => getSectionsBoundaries(utils, timezone), [utils, timezone]);
  const getSectionsFromValue = React15.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, isRTL, (date) => splitFormatIntoSections(utils, timezone, localeText, format, date, formatDensity, shouldRespectLeadingZeros, isRTL)), [fieldValueManager, format, localeText, isRTL, shouldRespectLeadingZeros, utils, formatDensity, timezone]);
  const placeholder = React15.useMemo(() => fieldValueManager.getValueStrFromSections(getSectionsFromValue(valueManager.emptyValue), isRTL), [fieldValueManager, getSectionsFromValue, valueManager.emptyValue, isRTL]);
  ...
  const selectedSectionIndexes = React15.useMemo(() => {
...
var useField = (params) => {
  ...
  const focusTimeoutRef = React17.useRef(void 0);
  const theme = useTheme();
  const isRTL = theme.direction === "rtl";
  const sectionOrder = React17.useMemo(() => getSectionOrder(state.sections, isRTL), [state.sections, isRTL]);
  ...
  const inputError = React17.useMemo(() => {
    if (error !== void 0) {
      return error;
    }
  ...
  const valueStr = React17.useMemo(() => {
    var _state$tempValueStrAn;
    return (_state$tempValueStrAn = state.tempValueStrAndroid) != null ? _state$tempValueStrAn : fieldValueManager.getValueStrFromSections(state.sections, isRTL);
  }, [state.sections, fieldValueManager, state.tempValueStrAndroid, isRTL]);
  const inputMode = React17.useMemo(() => {
    if (selectedSectionIndexes == null) {
      return "text";
    }
...
var DateField = React18.forwardRef(function DateField2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(TextField, _extends({
    ref
  }, fieldProps, {
...
var PickersPopperPaperWrapper = React33.forwardRef((props, ref) => {
  const {
    PaperComponent,
    popperPlacement,
...
function PickersPopper(inProps) {
  ...
  const paperRef = React33.useRef(null);
  ...
  return (0, import_jsx_runtime25.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      TransitionProps,
      placement: popperPlacement
    }) => (0, import_jsx_runtime25.jsx)(TrapFocus, _extends({
      open,
...
//# sourceMappingURL=chunk-WJMSMXK2.js.map
