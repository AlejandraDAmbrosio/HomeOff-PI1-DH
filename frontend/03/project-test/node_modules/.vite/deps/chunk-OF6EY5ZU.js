...
var _excluded4 = ["slots", "slotProps", "currentMonth", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onMonthChange", "onViewChange", "view", "reduceAnimations", "views", "labelId", "className", "timezone"];
...
var PickersCalendarHeader = React5.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime10.jsxs)(PickersCalendarDayHeader, {
      ...
      children: [displayWeekNumber && (0, import_jsx_runtime9.jsx)(PickersCalendarWeekNumberLabel, {
        ...
        return (0, import_jsx_runtime9.jsx)(PickersCalendarWeekDayLabel, {
          variant: "caption",
          role: "columnheader",
...
var useCalendarState = (params) => {
  ...
  const now = useNow(timezone);
  const utils = useUtils();
  const reducerFn = React11.useRef(createCalendarStateReducer(Boolean(reduceAnimations), disableSwitchToMonthOnDayFocus, utils)).current;
  ...
  const handleChangeMonth = React11.useCallback((payload) => {
    dispatch(_extends({
      type: "changeMonth"
    }, payload));
    if (onMonthChange) {
  ...
  const changeMonth = React11.useCallback((newDate) => {
...
//# sourceMappingURL=chunk-OF6EY5ZU.js.map
