...
import {
  ...
  useNow,
  useUtils
} from "./chunk-U24H4R4I.js";
import {
  useSlotProps
} from "./chunk-HXV3W62Z.js";
import {
  styled_default,
  useThemeProps
} from "./chunk-SZDLP4YD.js";
import {
  alpha,
  init_esm as init_esm2,
  useTheme_default
} from "./chunk-3LYSNJHH.js";
import {
  ...
  useForkRef,
  useId
} from "./chunk-EYAYQGC3.js";
import {
  clsx_default,
  init_clsx
} from "./chunk-X6IKZVGP.js";
import {
  require_prop_types
} from "./chunk-3CJIWT4G.js";
import {
  _extends,
  init_extends
...
var _excluded = ["autoFocus", "children", "disabled", "selected", "value", "tabIndex", "onClick", "onKeyDown", "onFocus", "onBlur", "aria-current", "monthsPerRow"];
...
var PickersMonth = React.memo(function PickersMonth2(inProps) {
  ...
  return (0, import_jsx_runtime.jsx)(PickersMonthRoot, _extends({
    ...
    children: (0, import_jsx_runtime.jsx)(PickersMonthButton, {
      ref,
      disabled,
      type: "button",
...
var _excluded2 = ["className", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "autoFocus", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone"];
...
var MonthCalendar = React2.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React2.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedMonth = React2.useMemo(() => {
    if (value != null) {
  ...
  const [focusedMonth, setFocusedMonth] = React2.useState(() => selectedMonth || todayMonth);
  ...
  const isMonthDisabled = React2.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime2.jsx)(MonthCalendarRoot, _extends({
    ref,
...
var PickersYear = React3.memo(function PickersYear2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersYear"
  });
  ...
  return (0, import_jsx_runtime3.jsx)(PickersYearRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState: props
  }, other, {
    children: (0, import_jsx_runtime3.jsx)(PickersYearButton, {
      ref,
      disabled,
      type: "button",
      tabIndex: disabled ? -1 : tabIndex,
...
var _excluded4 = ["autoFocus", "className", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsPerRow", "timezone"];
...
var YearCalendar = React4.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React4.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React4.useMemo(() => {
    if (value != null) {
  ...
  const [focusedYear, setFocusedYear] = React4.useState(() => selectedYear || todayYear);
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React4.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime4.jsx)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: utils.getYearRange(minDate, maxDate).map((year) => {
      ...
      return (0, import_jsx_runtime4.jsx)(PickersYear, {
        selected: isSelected,
        value: yearNumber,
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, {
    ...
    renderLoading: (_themeProps$renderLoa = themeProps.renderLoading) != null ? _themeProps$renderLoa : () => (0, import_jsx_runtime5.jsx)("span", {
      children: "..."
    }),
    minDate: applyDefaultDate(utils, themeProps.minDate, defaultDates.minDate),
    maxDate: applyDefaultDate(utils, themeProps.maxDate, defaultDates.maxDate)
...
var DateCalendar = React5.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  const prevOpenViewRef = React5.useRef(view);
  React5.useEffect(() => {
  ...
  const selectedDays = React5.useMemo(() => [value], [value]);
  return (0, import_jsx_runtime6.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime5.jsx)(CalendarHeader, _extends({}, calendarHeaderProps)), (0, import_jsx_runtime5.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
      className: classes.viewTransitionContainer,
      transKey: view,
      ownerState,
      children: (0, import_jsx_runtime6.jsxs)("div", {
        children: [view === "year" && (0, import_jsx_runtime5.jsx)(YearCalendar, _extends({}, baseDateValidationProps, commonViewProps, {
          value,
          ...
          yearsPerRow,
          referenceDate
        })), view === "month" && (0, import_jsx_runtime5.jsx)(MonthCalendar, _extends({}, baseDateValidationProps, commonViewProps, {
          hasFocus,
          className,
          value,
          ...
          monthsPerRow,
          referenceDate
        })), view === "day" && (0, import_jsx_runtime5.jsx)(DayCalendar, _extends({}, calendarState, baseDateValidationProps, commonViewProps, {
          onMonthSwitchingAnimationEnd,
...
true ? DateCalendar.propTypes = {
   ...
   */
  focusedView: import_prop_types3.default.oneOf(["day", "month", "year"]),
  /**
...
//# sourceMappingURL=chunk-WW6ETFL4.js.map
