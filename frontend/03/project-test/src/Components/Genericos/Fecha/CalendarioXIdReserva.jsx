...
const CalendarioXIdReserva = () => {
  ...
  return (
    ...
    <Button sx={{width:"100%", margin:"1rem 0.2rem 0.2rem 0.2rem", backgroundColor:"#9dd6b3", color:"#424242", ":hover": {
    backgroundColor: "#ff385c", color:"white"
  },}}>Reservar</Button>
    </Paper>
  );
};

export default CalendarioXIdReserva;
